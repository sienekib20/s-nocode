<?php $asked = [
    ['O que é preciso para começar?', 'Primeiro tens que ter uma conta no Sílica, depois escolha um plano (opcional), só assim que podes começar.', 'active', 'fa-minus'],
...
<div class="card py-5" style="background-color: #000; color: #fff">
    ...
    <div class="card-body my-4">
        <div class="container mt-5">
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <a href="https://silicaweb.ao/sfront/contact.php" target="_blank" class="btn-call-center">
                ...
                <div class="col-lg-6 col-12">
                    <a href="https://silicaweb.ao/sfront/" target="_blank" class="btn-call-center">

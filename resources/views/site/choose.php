                        ...
                        <div class="col-12 col-md-6 col-lg-7">
                            <div class="card-title col-12">
                                ...
                                <div class="d-flex mb-1" style="line-height: 1.5">
                                    <small>ID: <?= explode('-', $template->uuid)[2] ?></small>
                            ...
                            <div class="row ai-center">
                                <div class="col-12">
                                    <div class="input-group">
                                        <input type="text" id="dominio" placeholder="seudominio.ao" required class="form-input input-orange input-block">
                                    </div>
                                </div>
                            </div>
                            <div class="input-group">
                                <input type="text" id="mail" placeholder="Endereço email" required class="form-input input-orange input-block">
                            </div>
                            ...
                            <div class="d-flex mt-2">
                                ...
                                <div class="col-5 ml-auto px-0">
                                    <a href="#" target="_blank" class="choose-open-editor-btn btn btn-outline-orange input-block d-block mt-1 mb-2">
                                        <span class="fas fa-save"></span> <span>Salvar</span>
                                    </a>
                                </div>
                            </div>

                            <div class="d-flex ai-center jc-between py-2 in-use-item mt-3">

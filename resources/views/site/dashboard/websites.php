                            ...
                            <?php foreach ($data as $d) : ?>
                                <div class="col-lg-4 my-4 my-lg-0">
                                    <div class="dashitem-info pb-4">
                                        ...
                                        <small class="text-muted d-block">Data adesão: <?= $d->created_at ?> | Válido por 30 dias</small>
                                        <small class="text-muted d-block op-0">a</small>
                                        <div class="d-flex">
                                            <a href="#" class="d-flex  text-black text-underline"> <small>Ver</small></a>
                                            <a href="#" class="d-flex ml-4 text-black text-underline"> <small>excluir</small></a>
                                            <a href="#" class="d-flex ml-4 text-black text-underline"> <small>editar </small></a>
                                            <a href="#" class="d-flex ml-4 text-black text-underline"> <small>cancelar uso</small></a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php else : ?>
                            <span>Oops não tens nenhum website... carrege</span>
                        <?php endif; ?>    
                    </div>
                </div>
            </div>

        ...
        <div class="card ">
            <div class="card-top">
                <div class="container-sm">
                    <div class="row">
                        <div class="col-0 col-lg-1"></div>
                        <div class="card-title text-center col-12 col-lg-10">
                            ...
                            <form action="<?= route('purpose') ?>" method="post" class="col-12 col-lg-8 mx-auto mt-5">
...
<script>
    ...
    $(document).ready((e) => {
        $('#typeFrequenteQuestion').on('input', (e) => {
            const ff = new FormData(e.target.parentNode);
            const xhr = new XMLHttpRequest();
            xhr.open('GET', 'http://localhost:8000' + $('#faq-get').val());
            xhr.onload = () => {
